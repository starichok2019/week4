...
ниже есть примеры использования функций
...
def separator(simbol,count):
    ...
    """
    return count * simbol
print(separator('-', 8) == '--------')    # True
print(separator('&', 3) == '&&&')       # True
...
def hello_who(who='World'):
    ...
    """
    Функция печает приведствие в красивом формате
    **********

    Hello {Who}!

    ##########
    :param who: кого мы приветствуем, по умолчанию orld
    :return: None
    """
    print ('**********')
    print()
...
def pow_many(power, *args):
 ...
 # print(pow_many(2, 1, 2, 3, 4) == 100)    # True -> (1 + 2 + 3 + 4)**2 == 100
...
def my_filter(iterable, function):
      ...
      Если function от элемента последовательности возвращает True, то элемент входит в новую последовательность иначе нет (примеры ниже)
  ...
  #  print(my_filter([1, 2, 3, 4, 5], lamda x: x > 3) == [4, 5])                 # True
  #  print(my_filter([1, 2, 3, 4, 5], lamda x: x == 2) == [2])                   # True
  #  print(my_filter([1, 2, 3, 4, 5], lamda x: x != 3) == [1, 2, 4, 5])          # True
  #  print(my_filter(['a', 'b', 'c', 'd'], lamda x: x in)'abba' == ['a', 'b'])   # True
